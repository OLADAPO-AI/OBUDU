...
const Caurousel = () => {
  ...
  return (
    <div className=' max-w-[1240px] mx-auto px-4 py-16 relative flex justify-center items-center'>
      <HiArrowCircleLeft onClick={prevSlide} className=' text-slate-900 absolute top-[50%] text-4xl cursor-pointer left-8'/>
      <HiArrowCircleRight onClick={nextSlide} className=' text-slate-900 absolute top-[50%] text-4xl text-white cursor-pointer right-8'/>
